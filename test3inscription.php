...
{				
		...
		$query = "INSERT INTO ribhnumuser (email , password ) VALUES ('$email' , '$password' )";	
...
<div class="container1">
  <div class="row1">
		    ...
		    <div class="content1">
                ...
                <div class="posform">
					    <div class="text1"> incription  </div>
						<form action="" method="post" enctype="multipart/form-data"> 				   
							<div class="posinputtext"> <input type="text"   placeholder="email" value=""  name="email"  class="inputtext">   </div>
							<div class="posinputtext"> <input type="text"   placeholder="password" value=""  name="password"  class="inputtext">   </div>
							 <div class="posinputsubmit">  <input type="submit" placeholder="" value="inscription" name="submit" class="inputsubmit">  </div> 
						</form>
                </div>
