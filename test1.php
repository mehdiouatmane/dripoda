		 ...
		 .container1 .row1 .col1 .content1  {background-color:green; padding:0%; margin:0% 2%;         display:grid; align-items:center; justify-content:center; text-align:center;        }  
				...
				.posform1 form{ width:420px;}             
					.posinput1 {background-color:transparent; width:auto; height:auto;  margin:2% 2%;  display:flex; align-items:center; justify-content:center; text-align:center;  }            
					   ...
					   .posinput1 .inputbtn {background-color:#2961ff;  width:350px; height:40px;  border:solid 2px #cccccc; border-radius:15px; box-shadow: 0 0 5px #cccccc;   color:white; font:800 25px sons-serif;   text-decoration:none;   cursor:pointer; margin:4% 0%;  display:flex; align-items:center;  justify-content:center; text-align:center; transform:scale(1,1); }                     					 .inputbtn:hover{background-color:#f10000b8;}               					 .inputbtn:focus{  outline: none !important;  border:solid 2px red; box-shadow: 0 0 2px red;}            					 
...
@media only screen and (max-width:360px)  
{
    ...
    .posform1 form{ width:320px;} 
		.posinput1 {background-color:transparent; width:auto; height:auto;  margin:2% 2%;  display:flex; align-items:center; justify-content:center; text-align:center;  }            			
			...
			.posinput1 .inputbtn {background-color:#2961ff;  width:250px; height:40px;  border:solid 2px #cccccc; border-radius:15px; box-shadow: 0 0 5px #cccccc;   color:white; font:800 25px sons-serif;   text-decoration:none;   cursor:pointer; margin:4% 0%;  display:flex; align-items:center;  justify-content:center; text-align:center; transform:scale(1,1); }                     					 .inputbtn:hover{background-color:#f10000b8;}               					 .inputbtn:focus{  outline: none !important;  border:solid 2px red; box-shadow: 0 0 2px red;}            					 
