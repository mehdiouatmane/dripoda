		 ...
		 .container1 .row1 .col1 .content1  {background-color:green; padding:0%; margin:0% 0%;         display:grid; align-items:center; justify-content:center; text-align:center;        }  
				...
				.posform1 form{ width:420px;}             
					.posinput1 {background-color:transparent; width:auto; height:auto;  margin:2% 2%;  display:flex; align-items:center; justify-content:center; text-align:center;  }            
					   ...
					   .posinput1 .inputbtn {background-color:#ff0000;  width:350px; height:45px; margin:4% 0%;  border:solid 2px #dc3545; border-radius:15px; box-shadow: 0 0 5px #cccccc;   color:white; font:800 25px sons-serif;   text-decoration:none;   cursor:pointer; display:flex; align-items:center;  justify-content:center; text-align:center; transform:scale(1,1); }                     					 .inputbtn:hover{background-color:#f10000b8;}               					 .inputbtn:focus{  outline: none !important;  border:solid 2px red; box-shadow: 0 0 2px red;}            					 
		 					.inputhovererror{  background-color:#F8F8F9;   border-color:#cccccc; }  .inputhovererror::placeholder{  }		       
   ...
   .container2 .row1{background-color:transparent;   padding:0%; margin:0%;    display:flex; align-items:center; justify-content:center; text-align:center; flex-wrap:wrap;  }
		 ...
		 .container2 .row1 .col1 .content1  {background-color:transparent; padding:0%; margin:0% 0%;         display:grid; align-items:center; justify-content:center; text-align:center;        }  
				   ...
				   .container2 .row1 .col1 .content1 .text1{color:#0316f7; font:800 30px 'Cairo';}
                        ...
                        .carouselA1 .carouselA2 .owl-carousel.owl-loaded .owl-item {    width:500px;	display: flex;  align-items: center;   align-content: center;    justify-items:center;  justify-content: center;   text-align:center;    flex-wrap: nowrap;    flex-direction: row;   }
						...
						.carouselB1 .carouselB2{ background-color:white; width:500px; height:auto;  display:flex; align-items:center;  justify-content:center;  justify-items: center;  text-align:center;   }	
                        .carouselB1 .carouselB2 .owl-carousel.owl-loaded .owl-item {    width:500px;	display: flex;  align-items: center;   align-content: center;    justify-items:center;  justify-content: center;   text-align:center;    flex-wrap: nowrap;    flex-direction: row;   }
							.carouselB1 .carouselB2 .item {background-color:red; width:100px; height:auto;   padding: 10px 0px;  margin:0px;    border-radius:3px;  cursor:pointer;   display:flex; align-items:center; justify-content:center;  text-align:center; }          .carouselB1 .carouselB2 .current .item {  background-color: black;}
...
@media only screen and (max-width:530px)  
{
	...
	.container2 .row1 .col1 .content1 .text1{color:#0316f7; font:800 25px 'Cairo';}
		...
		.carouselA1 .carouselA2 .item {background-color:transparent; width:330px; height:auto; padding:0%;  margin:0%; border-radius:3px;   cursor:pointer;  display:flex; align-items:center; justify-content:center; text-align:center; }      .carouselA1 .carouselA2 .item:hover{ background-color:blue; }   
...
<div class="container2">
  <div class="row1">
	...
	<div class="content1">
				...
				<div class="posdescription"> <div class="description">  الحقيبة متوفرة بالوان مختلفة ومصنوعة من مواد دو جودة عالية ومضاذة للمياه والتمزق والخدش ومنضرها جداب جدا ولها العديد من المميزات ستكتشفينها بنفسك فمدا تنتضرين ياسيدتي سارعي بالطلب فالكمية محدودة  </div>  </div>
