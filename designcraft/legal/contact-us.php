...
.container1 {width:100%; height:auto; padding:0% 0%; margin:0% 0%; }
	...
	.row2{padding:0% 0%; margin:2% 0%;    display:flex; align-items:center;  align-content:center; justify-content:center; text-align:center;  }       
        .row2 .col1a{width:100%;}   .row2 .col1b{padding:0px 0px; margin:0% 20%;    display:inline-block; align-items:start; justify-content:center; text-align:center;   }
...
<div class="container1">
		    ...
		    <div class="row2">
			   <div class="col1a"> <div class="col1b">
					...
					<div>Email: contact@driposhop.com</div>
					<div>Address:London , United Kingdom</div>
					<div style="margin:5% 0% 0% 0%;">Or using the form bellow:</div>
					    <div style="display:grid;">
						  <label>Name</label> <input type="text"  name="Name"  placeholder="Name" autocapitalize="words" autofocus="autofocus">
						  <label>Email</label><input type="email" name="email" placeholder="Email" autocorrect="off" autocapitalize="none" pattern="^[a-zA-Z0-9.!#$%&amp;'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+$" required="required" aria-required="true">
						  <label>Phone Number</label>  <input type="tel" name="PhoneNumber" placeholder="Phone Number" pattern="[0-9\-]*">
						  <label>Message</label>  <textarea rows="3"  name="message" placeholder="Message"></textarea>
						  <input style="background-color:black; color:white; font:600 20px 'cairo'; border-radius:5px;" type="submit" value="SEND"  name="send" >
	                    </div>
				</div></div>
		    </div>
	...
	<div class="row7">	
			<div class="col1a">  <div class="col1b"> 
				<div class="legal">
					<div class="text"> <a href="privacy-policy.php">Privacy policy</a> </div>
					<div class="text"> <a href="terms-of-service.php">terms of service</a> </div>					 
					<div class="text"> <a href="refund-policy.php">Refund policy</a> </div>
					<div class="text"> <a href="shipping-policy.php">Shipping policy</a> </div>					
					<div class="text"> <a href="faqs.php">FAQs</a> </div>
					<div class="text"> <a href="about-us.php">About us</a> </div>										   
					<div class="text"> <a href="contact-us.php">Contact us</a> </div>
				</div>				
			    <div class="footer">
